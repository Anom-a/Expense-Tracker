...
<head>
    ...
    <title>Registration - ExpenseTracker</title>
    <!-- Fonts -->
        ...
        <div class="w-full max-w-[480px] flex flex-col animate-bounce-in">
            ...
            <div class="bg-surface-light dark:bg-surface-dark rounded-2xl shadow-card border border-border-color/30 dark:border-gray-800 p-6 sm:p-10 transition-colors duration-300 hover-lift">
                ...
                <div class="mb-8 text-center sm:text-left">
                    <h1 class="text-text-main dark:text-white text-3xl font-bold leading-tight mb-2 tracking-tight">Create your account</h1>
                    <p class="text-text-secondary dark:text-gray-400 text-sm font-normal leading-relaxed">Join thousands of students and pros mastering their budget today.</p>
                </div>
                <!-- Form -->
                <form action="register" method="post" class="flex flex-col gap-5">
                    <!-- Name Field -->
                    <div class="space-y-2">
                        <label class="text-text-main dark:text-gray-200 text-sm font-semibold leading-normal" for="name">Full Name</label>
                        <div class="relative group">
                            <input class="w-full h-12 px-4 rounded-lg bg-background-light dark:bg-background-dark border border-border-color dark:border-gray-700 text-text-main dark:text-white placeholder:text-text-secondary/70 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-base input-focus" id="name" name="name" placeholder="Enter your full name" type="text" required/>
                        </div>
                    </div>
                    <!-- Email Field -->
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input class="w-full h-12 px-4 pr-12 rounded-lg bg-background-light dark:bg-background-dark border border-border-color dark:border-gray-700 text-text-main dark:text-white placeholder:text-text-secondary/70 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-base input-focus" id="password" name="password" placeholder="Create a strong password" type="password" required/>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-text-secondary dark:text-gray-400">
                        ...
                        <a class="font-bold text-primary hover:text-primary-hover hover:underline transition-all" href="login">Log In</a>
                    </p>
                </div>
            </div>
